...
dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:omdsh-dev/dsh-ui-whale#v0.3.16'
...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:omdsh-dev/dsh-ui-whale#v0.3.16'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
...
> Pinning the tag for git dependencies (public mirror, recommended): `pnpm add '@dsh-external/dsh-ui-whale@github:omdsh-dev/dsh-ui-whale#v0.3.16'` (or `github:omdsh-dev/dsh-ui-whale`; historical: 0810/0811 users use `#v0.3.3`, 0806~0809 users `#v0.3.2`, 0805 users `#v0.1.0`).
